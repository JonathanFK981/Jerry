...
DATA_PATH = '/home/administrator/deeplearning/code/Gayhub/detection/MOT/Jerry/ByteTrack/datasets/Jerry'
    ...
    for split in SPLITS:
        ...
        for seq in sorted(seqs):
            ...
            for i in range(anns.shape[0]):
                ...
                cat_id = int(anns[i][7])
                ann_cnt += 1
                if (anns[i][8] == 2):  # visibility.#TODO:make annotations's file num don't match bianli gt num
                    continue
